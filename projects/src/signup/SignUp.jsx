...
console.log(values);
  return (<div className='wrapp'>
    <div className='app'>
        ...
        <h1 className='h1'>Registeration Form</h1>
          {
            inputs.map((input)=>(
          ...
          <h5 className="h1">Already Have An Account? <Link to="/login">Login</Link></h5>
            <Link to="/login"><button className='signbttn'>Submit</button></Link>
