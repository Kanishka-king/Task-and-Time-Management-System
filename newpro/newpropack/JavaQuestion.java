...
class JavaQuestion extends Questions {
    public JavaQuestion(String question, String option1, String option2, String option3, String option4, Character correctAnswer) {
