...
class GkQuestion extends Questions {
    public GkQuestion(String question, String option1, String option2, String option3, String option4, Character correctAnswer) {
